...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.apis(RequestHandlerSelectors.basePackage("com.example.cursomc.resources")).paths(PathSelectors.any())
				.build().apiInfo(apiInfo());
	}

	private ApiInfo apiInfo() {
		return new ApiInfo("API do projeto ionic", "Esta API é utilizada no heroku do projeto ionic", "Versão 1.0",
				"https://www.udemy.com/terms",
				new Contact("André Paulin", "https://github.com/AFPaulin/", "andrefaramilio121@gmail.com"),
				"Uso para documentação", "https://www.udemy.com/terms", Collections.emptyList() // Vendor
																								// Extensions
		);
	}
